...
export default function MyDiet() {
  ...
  // ✅ Load existing plan values from backend
  useEffect(() => {
    const loadExistingData = async () => {
      ...
      try {
        ...
        const currentPlan = response?.current_plan;
        ...
        VARIABLE_GROUPS.diet
          ...
          .forEach((key) => {
            ...
            if (
              ...
              const value = currentPlan[
                keyStr as keyof typeof currentPlan
              ];
        ...
        console.error(
          "[DIET] Failed to load existing data:",
          err
        );
      }
    };
              ...
              return (
                <div key={keyStr} className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setValue(keyStr, parseInt(v))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue
                        placeholder={`Select ${keyStr.replace(
                          /_/g,
                          " "
                        )}`}
                      />
